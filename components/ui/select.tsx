...
/** Canonical shadcn/ui select built on @radix-ui/react-select. The previous
 *  hand-rolled stub could not open, close, or keyboard-navigate; this gives
 *  the Header (and future placements) a fully accessible dropdown that
 *  portals, positions, and animates correctly in both themes. */
...
interface SelectTriggerProps
  ...
  /** shadcn size hint - rendered as data-size, not a Radix prop. */
  size?: "default" | "sm";
}
