...
/** Single cross-site promo: FRELUX PROJECT CALC (Nigerian construction
 *  calculators) advertised to Heartsyncx readers. */
export const FreluxCrossPromo: React.FC = () => (
  <div className="my-8 p-5 sm:p-6 rounded-2xl bg-zinc-900 dark:bg-zinc-950 text-white border border-zinc-800 shadow-lg text-left relative overflow-hidden">
    ...
    <a
      ...
      onClick={() => trackEvent('cross_promo_click', { target_site: 'frelux', source: 'heartsyncx_article' })}
    ...
    >
      ...
      <span className="mt-1.5 block text-xs sm:text-sm text-zinc-300 leading-relaxed">
        Free Nigerian construction calculators for paint, screeding, POP ceiling and tiles, plus
        cost estimates with real material prices, and verified pros you can hire.
      </span>
      <span className="mt-2.5 flex items-center gap-1.5 text-[11px] font-bold text-emerald-400">
        <ExternalLink className="w-3.5 h-3.5" />
        Visit freluxtools.netlify.app
      </span>
    </a>
  </div>
);
